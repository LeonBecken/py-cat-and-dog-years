...
def test_should_return_two_cats_and_two_dogs():
...
def test_should_return_three_for_cat_28_and_dog_29():
...
def test_should_return_three_cats_and_two_dogs_when_cat_reaches_boundary():
    assert main.get_human_age(28, 24) == [3, 2]


def test_should_return_two_cats_and_three_dogs_when_dog_reaches_boundary():
